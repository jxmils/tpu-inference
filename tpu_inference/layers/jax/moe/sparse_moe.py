...
def sparse_moe_distributed_fwd(
    ...
    *,
    ...
    # 1. Global Permute
    with tpu_trace_region("moe_permute_global"):
        (
            sorted_inputs,
            global_sort_indices,
            global_group_sizes,
    ...
    if moe_instance.num_expert_parallelism > 1:
        ...
        if moe_instance.is_batch_sharded_by_expert:
            ...
            with tpu_trace_region("moe_all2all_dispatch"):
            ...
            # 3a. Local Permute
            with tpu_trace_region("moe_post_dispatch_permute"):
            ...
            with tpu_trace_region("moe_local_route"):
                (
                    compute_inputs,
                    local_sorted_indices,
                    compute_group_sizes,
    ...
    with tpu_trace_region("moe_experts"):
    ...
    if moe_instance.num_expert_parallelism > 1:
        with tpu_trace_region("moe_all2all_return"):
            local_total_assignments = x_TD.shape[
                0] * moe_instance.num_experts_per_tok
    ...
    # 6. Global Unpermute
    with tpu_trace_region("moe_unpermute"):
